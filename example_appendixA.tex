...
Su finalidad puede ser completar el cuerpo del trabajo con información que no ha encajado para no romper la presentación lógica y ordenada, u ofrecer datos complementarios que ayuden a entender los empleados. También se pueden incluir otros materiales complementarios, difícilmente intercalables como planos, muestras, fotografías, glosarios, etc. La información complementaria del trabajo incluida en los anexos se citará al final de cada uno de ellos.
