...
\begin{lstlisting}[caption={example.cpp},captionpos=b]
for (int i = 0; i < iterations; i++)
{
    // Check
    i++;
    std::cout << "asdfasdf" << std::endl; (*\label{code:printf}*)
}
\end{lstlisting}
...
{
    for i in range(5):
        print("Go home.") (*\label{code:print}*)
}
\end{lstlisting}

We produce the output in line \ref{code:print}.
