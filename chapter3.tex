...
The points are packed in a custom created \lstinline{ros_robotic_skin::PointArray} message, whose only field is an array of \lstinline{geometry_msgs::Point}s. This is done at \SI{50}{\hertz}, or what is the same, every \SI{20}{\milli \second}.
