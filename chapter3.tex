...
In order to accomplish this the method presented in \cite{stackexchangeSegment} has been implemented.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Once the value of $t$ is computed, if it is between $0$ and $1$, then the closest point is $(1-t)A + t B$. If it is not, $\min\left(g(0),g(1)\right)$ is the answer.
    \end{enumerate}

    \item Choose the point corresponding to the minimum distance value between all of the segments.
\end{enumerate}
