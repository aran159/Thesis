...
We can verify $\mathbf{Q}$ is semi-positive definite and that consequently the problem is convex with the following two theorems:
...
As far as the constraints are concerned, three types are implemented. First type is used for joint position, velocity and acceleration limiting and two different types of constraints for obstacle avoidance.